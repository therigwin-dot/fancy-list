    ...
    FancyListWebPart.prototype.getPropertyPaneConfiguration = function () {
        return {
            pages: [
                {
                    header: {
                        description: FancyListWebPartStrings__WEBPACK_IMPORTED_MODULE_6__.PropertyPaneDescription
                    },
                    groups: [
                        {
                            groupName: FancyListWebPartStrings__WEBPACK_IMPORTED_MODULE_6__.BasicGroupName,
                            groupFields: [
                                ...
                                (0,_microsoft_sp_property_pane__WEBPACK_IMPORTED_MODULE_3__.PropertyPaneToggle)('showAllCategories', {
                                    label: 'Show "All" Category Option',
                                    onText: 'On',
                                    offText: 'Off'
                                }),
                                (0,_microsoft_sp_property_pane__WEBPACK_IMPORTED_MODULE_3__.PropertyPaneToggle)('defaultExpanded', {
