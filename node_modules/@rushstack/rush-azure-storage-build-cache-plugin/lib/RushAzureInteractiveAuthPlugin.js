...
class RushAzureInteractieAuthPlugin {
    ...
    apply(rushSession, rushConfig) {
        ...
        const handler = async () => {
            ...
            const { storageAccountName, storageContainerName, azureEnvironment = 'AzurePublicCloud', minimumValidityInMinutes, loginFlow = process.env.CODESPACES ? 'AdoCodespacesAuth' : 'InteractiveBrowser' } = options;
