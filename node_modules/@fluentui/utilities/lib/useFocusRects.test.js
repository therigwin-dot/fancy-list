...
describe('useFocusRects', function () {
    ...
    describe('when attaching the classnames to the window body', function () {
        it('can hint to show focus when you press a directional key', function () {
            act(function () {
                focusRects1 = renderer.create(React.createElement(FocusRects, { rootRef: mockRefObject }));
                focusRects2 = renderer.create(React.createElement(FocusRects, { rootRef: mockRefObject }));
            });
        ...
        it('can hint to show focus when you press a directional key with multi-window', function () {
            act(function () {
                focusRects1 = renderer.create(React.createElement(FocusRects, { rootRef: mockRefObject }));
                focusRects2 = renderer.create(React.createElement(FocusRects, { rootRef: mockRefObject2 }));
            });
        ...
        it('can disable focus rects', function () {
            ...
            var component;
            act(function () {
                component = renderer.create(React.createElement(FocusRects, { rootRef: mockRefObject }));
            });
            var eventListeners = mockWindow.eventListeners;
