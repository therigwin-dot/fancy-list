...
describe('useCustomizatioSettings', function () {
    ...
    it('get settings from CustomizerContext', function () {
        ...
        act(function () {
            component = renderer.create(React.createElement(CustomizerContext.Provider, { value: newContext },
        ...
        act(function () {
            component.update(React.createElement(CustomizerContext.Provider, { value: updatedContext },
                React.createElement(TestComponent, null)));
        });
        expect(settingsStates.length).toBe(2);
