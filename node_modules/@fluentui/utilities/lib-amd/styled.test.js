define(["require", "exports", "tslib", "react", "react-test-renderer", "./styled", "./customizations/Customizer", "@fluentui/merge-styles", "./classNamesFunction", "./customizations/Customizations", "@fluentui/test-utilities"], function (require, exports, tslib_1, React, renderer, styled_1, Customizer_1, merge_styles_1, classNamesFunction_1, Customizations_1, test_utilities_1) {
    "use strict";
    ...
    describe('styled', function () {
        ...
        it('can create pure components', function () {
            ...
            act(function () {
                component = renderer.create(React.createElement(App, null));
            });
            expect(renderCount).toEqual(2);
            act(function () {
                component.update(React.createElement(App, { "data-foo": "1" }));
            });
        ...
        it('does not create any new closured functions', function () {
            var _firstProps;
            act(function () {
                component = renderer.create(React.createElement(Test, null));
            });
            _firstProps = _lastProps;
            expect(_renderCount).toEqual(1);
            act(function () {
                component.update(React.createElement(Test, { cool: true }));
            });
        ...
        it('can re-render when customized styles change', function () {
            ...
            act(function () {
                component.update(React.createElement(Test, { "data-foo": 1 }));
            });
            expect(_styleEval).toEqual(1);
        });
        ...
        it('will not re-render if styles have not changed', function () {
            var firstStylesProp;
            act(function () {
                component = renderer.create(React.createElement(Test, { styles: { root: { background: 'red' } } }));
                firstStylesProp = lastStylesInBaseComponent;
            });
            expect(_renderCount).toEqual(1);
            act(function () {
                component.update(React.createElement(Test, { cool: true, styles: { root: { background: 'red' } } }));
            });
            expect(_renderCount).toEqual(2);
