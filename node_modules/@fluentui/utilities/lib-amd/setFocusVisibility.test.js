define(["require", "exports", "react", "react-test-renderer", "./useFocusRects", "./setFocusVisibility", "./dom/getWindow"], function (require, exports, React, renderer, useFocusRects_1, setFocusVisibility_1, getWindow) {
    "use strict";
    ...
    describe('setFocusVisibility', function () {
        ...
        beforeEach(function () {
            ...
            classNames = [];
            component = renderer.create(React.createElement(useFocusRects_1.FocusRects, null));
        });
        afterEach(function () { return component.unmount(); });
