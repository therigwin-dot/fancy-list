define(["require", "exports", "tslib", "react", "./initializeComponentRef", "react-test-renderer"], function (require, exports, tslib_1, React, initializeComponentRef_1, renderer) {
    "use strict";
    ...
    describe('initializeComponentRef', function () {
        ...
        it('can resolve componentRef', function () {
            ...
            var component = renderer.create(React.createElement(Foo, { componentRef: fooRef }));
