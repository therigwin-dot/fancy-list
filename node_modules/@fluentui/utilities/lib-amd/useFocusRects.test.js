define(["require", "exports", "react", "react-test-renderer", "./useFocusRects", "./FocusRectsProvider", "./setFocusVisibility", "./KeyCodes", "./keyboard"], function (require, exports, React, renderer, useFocusRects_1, FocusRectsProvider_1, setFocusVisibility_1, KeyCodes_1, keyboard_1) {
    "use strict";
    ...
    describe('useFocusRects', function () {
        ...
        describe('when attaching the classnames to the window body', function () {
            it('can hint to show focus when you press a directional key', function () {
                act(function () {
                    focusRects1 = renderer.create(React.createElement(useFocusRects_1.FocusRects, { rootRef: mockRefObject }));
                    focusRects2 = renderer.create(React.createElement(useFocusRects_1.FocusRects, { rootRef: mockRefObject }));
                });
            ...
            it('can hint to show focus when you press a directional key with multi-window', function () {
                act(function () {
                    focusRects1 = renderer.create(React.createElement(useFocusRects_1.FocusRects, { rootRef: mockRefObject }));
                    focusRects2 = renderer.create(React.createElement(useFocusRects_1.FocusRects, { rootRef: mockRefObject2 }));
                });
            ...
            it('can disable focus rects', function () {
                ...
                var component;
                act(function () {
                    component = renderer.create(React.createElement(useFocusRects_1.FocusRects, { rootRef: mockRefObject }));
                });
                var eventListeners = mockWindow.eventListeners;
        ...
        describe('when attaching the classnames to the a provider element', function () {
            ...
            it('can hint to show focus when you press a directional key', function () {
                ...
                act(function () {
                    focusRects1 = renderer.create(React.createElement(FocusRectsWithProvider, { providerRef: providerRef, rootRef: mockRefObject }));
                });
            ...
            it('can disable focus rects', function () {
                ...
                var component;
                act(function () {
                    component = renderer.create(React.createElement(FocusRectsWithProvider, { providerRef: providerRef, rootRef: mockRefObject }));
                });
                var providerElem = providerRef.current;
                var eventListeners = providerElem.eventListeners;
                expect(eventListeners.keyup).toBeUndefined();
