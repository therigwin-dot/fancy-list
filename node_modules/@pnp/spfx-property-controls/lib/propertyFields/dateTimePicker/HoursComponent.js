 ...
 */
export default class HoursComponent extends React.Component {
    render() {
        ...
        return (React.createElement(Dropdown, { disabled: this.props.disabled, label: '', options: hours, onChanged: this.props.onChange, dropdownWidth: 110 }));
    }
}
