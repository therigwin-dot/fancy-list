 ...
 */
class PropertyFieldPeoplePickerBuilder {
    /**
     * Constructor method
     */
    ...
    render(elem, ctx, changeCallback) {
        ...
        const element = React.createElement(PropertyFieldPeoplePickerHost, {
            label: this.label,
...
export function PropertyFieldPeoplePicker(targetProperty, properties) {
    ...
    return new PropertyFieldPeoplePickerBuilder(targetProperty, Object.assign(Object.assign({}, properties), { targetProperty: targetProperty, onDispose: null, onRender: null }));
}
