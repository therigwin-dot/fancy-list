...
var AdaptiveCardExtensionTestWrapper = /** @class */ (function () {
    ...
    AdaptiveCardExtensionTestWrapper.prototype._logCardActionEngagement = function (actionType, location, mobileSessionId, mobileBootType) {
        this._adaptiveCardExtension = new this._cls();
        this._adaptiveCardExtension._internalInitialize(this._getContext(this._testData), false, sp_core_library_1.DisplayMode.Read, TEST_TAG_NAME, false, undefined);
        Object.defineProperty(this._adaptiveCardExtension.cardNavigator._currentView instanceof index_1.BaseCardView
            ? this._adaptiveCardExtension.cardNavigator
            : this._adaptiveCardExtension.cardNavigator._currentView, this._adaptiveCardExtension.cardNavigator._currentView instanceof index_1.BaseCardView
            ? '_currentView'
            : 'view', {
            value: 'mocked value'
        });
    ...
    Object.defineProperty(AdaptiveCardExtensionTestWrapper.prototype, "currentCardView", {
        get: function () {
            return this._adaptiveCardExtension.cardNavigator._currentView instanceof index_1.BaseCardView
                ? this._adaptiveCardExtension.cardNavigator._currentView
                : this._adaptiveCardExtension.cardNavigator._currentView.view;
        },
        enumerable: false,
        configurable: true
    });
    Object.defineProperty(AdaptiveCardExtensionTestWrapper.prototype, "currentQuickView", {
        get: function () {
            return this._adaptiveCardExtension.quickViewNavigator._currentView instanceof index_1.BaseQuickView
                ? this._adaptiveCardExtension.quickViewNavigator._currentView
                : this._adaptiveCardExtension.quickViewNavigator._currentView.view;
        },
        enumerable: false,
        configurable: true
    });
