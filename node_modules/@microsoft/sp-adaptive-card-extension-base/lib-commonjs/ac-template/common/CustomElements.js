...
var TEXT_INPUT = function (parameters, componentId) {
    ...
    if (parameters.iconAfter) {
        columnSet.columns.push({
            ...
            width: '16px', // if we provide number here, the final JSON will be incorrect and the width will not be applied.
            spacing: 'none',
            items: [
                {
                    type: 'Icon',
        ...
        items: [
            {
                ...
                url: '${footerImageUrl}',
                // eslint-disable-next-line @typescript-eslint/no-explicit-any
                height: '24px', // if we provide number here, the final JSON will be incorrect and the width will not be applied.
                width: '24px'
            }
        ]
    });
