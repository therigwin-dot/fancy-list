...
exports.ViewNavigator = exports.EmptyQuickView = void 0;
...
exports.EmptyQuickView = EmptyQuickView;
/**
...
var ViewNavigator = /** @class */ (function () {
    function ViewNavigator(handleStackChangedCallback, handleInitializeCallback) {
        ...
        this._viewStack = (0, Killswitches_1.isKeyboardFocusViewNavChangesKSActivated)()
            ? new Array()
            : new Array();
    ...
    Object.defineProperty(ViewNavigator.prototype, "currentId", {
        ...
        get: function () {
            var size = this.size;
            return size && (0, Killswitches_1.isKeyboardFocusViewNavChangesKSActivated)()
                ? this._viewStack[size - 1]
                : size
                    ? this._viewStack[size - 1].id
                    : undefined;
        },
        enumerable: false,
        configurable: true
    ...
    Object.defineProperty(ViewNavigator.prototype, "_currentView", {
        ...
        get: function () {
            ...
            if ((0, Killswitches_1.isKeyboardFocusViewNavChangesKSActivated)()) {
                return this._viewCache.get(this._viewStack[size - 1]);
            }
            return tslib_1.__assign(tslib_1.__assign({}, this._viewStack[size - 1]), { view: this._viewCache.get(this._viewStack[size - 1].id) });
        },
        enumerable: false,
        configurable: true
    });
    ...
    ViewNavigator.prototype._push = function (id) {
        ...
        if ((0, Killswitches_1.isKeyboardFocusViewNavChangesKSActivated)()) {
            ...
            /**
             * Prior to pushing the incoming view onto the `_viewStack`, set the last focused element of the current view.
             * This stored reference allows the element to receive focus when navigating back to this view.
             */
            if (this.size > 0) {
                this._viewStack[this.size - 1].focusElement =
                    (_a = document.activeElement) !== null && _a !== void 0 ? _a : undefined;
            }
