...
exports.noAsyncAwaitRule = exports.MESSAGE_ID = void 0;
exports.MESSAGE_ID = 'error-async-await';
const noAsyncAwaitRule = {
    defaultOptions: [],
    meta: {
        type: 'problem',
        messages: {
            [exports.MESSAGE_ID]: 'Usage of "async" has overhead when using in older browsers.'
        },
        schema: [],
        docs: {
    ...
    create: (context) => {
        ...
        const checkAndReportAsyncFunction = (node) => {
            if (node.async) {
                context.report({ node, messageId: exports.MESSAGE_ID });
            }
        };
        return {
