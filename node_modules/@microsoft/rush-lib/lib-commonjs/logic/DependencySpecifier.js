...
})(DependencySpecifierType || (exports.DependencySpecifierType = DependencySpecifierType = {}));
/**
...
class DependencySpecifier {
    constructor(packageName, versionSpecifier) {
        ...
        const result = npm_package_arg_1.default.resolve(packageName, versionSpecifier);
