    ...
    for (const dependencyName of Object.keys(dependencies)) {
        ...
        if (currentVersion.startsWith('workspace:')) {
            ...
            if (workspaceProjectInfo) {
                ...
                let relativePath = path_1.default.normalize(path_1.default.relative(workspaceProject.projectRelativeFolder, workspaceProjectInfo.projectRelativeFolder));
                ...
                if (aliasedWorkspaceProjectInfo) {
                    const relativePath = path_1.default.normalize(path_1.default.relative(workspaceProject.projectRelativeFolder, aliasedWorkspaceProjectInfo.projectRelativeFolder));
