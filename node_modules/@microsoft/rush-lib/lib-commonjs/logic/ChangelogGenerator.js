...
const changelog_schema_json_1 = __importDefault(require("../schemas/changelog.schema.json"));
...
class ChangelogGenerator {
    ...
    static _getChangelog(packageName, projectFolder) {
        ...
        if (node_core_library_1.FileSystem.exists(changelogFilename)) {
            changelog = node_core_library_1.JsonFile.loadAndValidate(changelogFilename, ChangelogGenerator.jsonSchema);
        }
        if (!changelog) {
            changelog = {
                name: packageName,
 ...
 */
ChangelogGenerator.jsonSchema = node_core_library_1.JsonSchema.fromLoadedObject(changelog_schema_json_1.default);
