...
class WorkspaceInstallManager extends BaseInstallManager_1.BaseInstallManager {
    ...
    async prepareCommonTempAsync(subspace, shrinkwrapFile) {
            ...
            for (const { name, version, dependencyType } of [
                ...
                if ((dependencySpecifier.specifierType === DependencySpecifier_1.DependencySpecifierType.Version ||
                    ...
                    if (!semver.satisfies(referencedLocalProject.packageJsonEditor.version, dependencySpecifier.versionSpecifier)) {
                        ...
                        console.log();
                        // eslint-disable-next-line no-console
                        console.log(terminal_1.Colorize.red(`"${rushProject.packageName}" depends on package "${name}" (${version}) which belongs to ` +
        ...
        const overridesAreEqual = (0, objectUtilities_1.objectsAreDeepEqual)((_a = pnpmOptions.globalOverrides) !== null && _a !== void 0 ? _a : {}, (shrinkwrapFile === null || shrinkwrapFile === void 0 ? void 0 : shrinkwrapFile.overrides) ? Object.fromEntries(shrinkwrapFile === null || shrinkwrapFile === void 0 ? void 0 : shrinkwrapFile.overrides) : {});
        ...
        InstallHelpers_1.InstallHelpers.generateCommonPackageJson(this.rushConfiguration, subspace, undefined, this._terminal);
    ...
    async postInstallAsync(subspace) {
        ...
        const tempShrinkwrapFile = ShrinkwrapFileFactory_1.ShrinkwrapFileFactory.getShrinkwrapFile(this.rushConfiguration.packageManager, subspace.getTempShrinkwrapFilename());
