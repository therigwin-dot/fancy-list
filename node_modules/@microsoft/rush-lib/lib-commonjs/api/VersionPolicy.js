...
})(VersionPolicyDefinitionName || (exports.VersionPolicyDefinitionName = VersionPolicyDefinitionName = {}));
/**
...
class VersionPolicy {
    ...
    constructor(versionPolicyJson) {
        ...
        this.definitionName = node_core_library_1.Enum.getValueByKey(VersionPolicyDefinitionName, versionPolicyJson.definitionName);
...
class LockStepVersionPolicy extends VersionPolicy {
    ...
    _updatePackageVersion(project, newVersion) {
        const updatedProject = (0, objectUtilities_1.cloneDeep)(project);
