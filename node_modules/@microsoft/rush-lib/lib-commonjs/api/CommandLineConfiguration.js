...
const command_line_schema_json_1 = __importDefault(require("../schemas/command-line.schema.json"));
...
const DEFAULT_REBUILD_COMMAND_JSON = {
    ...
    description: 'This command assumes that the package.json file for each project contains' +
        ...
        ` Rush invokes this script to build each project that is registered in ${RushConstants_1.RushConstants.rushJsonFilename}.` +
    ...
    constructor(commandLineJson, options = {}) {
        ...
        if (phasesJson) {
            ...
            for (const phase of phasesJson) {
                ...
                if (phase.ignoreMissingScript !== undefined && phase.missingScriptBehavior !== undefined) {
                    throw new Error(`In ${RushConstants_1.RushConstants.commandLineFilename}, the phase "${phase.name}"'s defines ` +
        ...
        if (!options.doNotIncludeDefaultBuildCommands) {
            ...
            if (!this.commands.has(RushConstants_1.RushConstants.rebuildCommandName)) {
                ...
                const rebuildCommand = Object.assign(Object.assign({}, DEFAULT_REBUILD_COMMAND_JSON), { commandKind: RushConstants_1.RushConstants.phasedCommandKind, isSynthetic: true, phases: buildCommandPhases, disableBuildCache: DEFAULT_REBUILD_COMMAND_JSON.disableBuildCache, associatedParameters: buildCommand.associatedParameters, originalPhases: buildCommandOriginalPhases, watchPhases: new Set(), alwaysWatch: false, alwaysInstall: undefined });
...
CommandLineConfiguration._jsonSchema = node_core_library_1.JsonSchema.fromLoadedObject(command_line_schema_json_1.default);
