...
exports.SelectionParameterSet = exports.SUBSPACE_LONG_ARG_NAME = void 0;
...
const SubspaceSelectorParser_1 = require("../../logic/selectors/SubspaceSelectorParser");
const RushConstants_1 = require("../../logic/RushConstants");
exports.SUBSPACE_LONG_ARG_NAME = '--subspace';
/**
...
class SelectionParameterSet {
    constructor(rushConfiguration, action, options) {
        ...
        selectorParsers.set('subspace', new SubspaceSelectorParser_1.SubspaceSelectorParser(rushConfiguration));
        ...
        if (includeSubspaceSelector) {
            this._subspaceParameter = action.defineStringParameter({
                parameterLongName: exports.SUBSPACE_LONG_ARG_NAME,
    ...
    async getSelectedProjectsAsync(terminal) {
        ...
        if ((_b = this._subspaceParameter) === null || _b === void 0 ? void 0 : _b.value) {
            if (!this._rushConfiguration.subspacesFeatureEnabled) {
                ...
                console.log();
                // eslint-disable-next-line no-console
                console.log(terminal_1.Colorize.red(`The "${exports.SUBSPACE_LONG_ARG_NAME}" parameter can only be passed if "subspacesEnabled" ` +
        ...
        Selection_1.Selection.expandAllConsumers(fromProjects))), subspaceProjects, 
            ...
            if (rawSelector === '.') {
                ...
                if (packageJson) {
                    ...
                    if (project) {
                        ...
                        terminal.writeErrorLine(`Rush is not currently running in a project directory specified in ${RushConstants_1.RushConstants.rushJsonFilename}. ` +
