    ...
    async runAsync() {
        ...
        for (const filename of scanResults) {
            try {
                ...
                console.log(terminal_1.Colorize.bold('Skipping file due to error: ' + filename));
            }
        }
        ...
        if (this._jsonFlag.value) {
            ...
            if (missingDependencies.length > 0) {
                // eslint-disable-next-line no-console
                console.log(terminal_1.Colorize.yellow('Possible phantom dependencies') +
            ...
            if (unusedDependencies.length > 0) {
                ...
                // eslint-disable-next-line no-console
                console.log(terminal_1.Colorize.yellow('Possible unused dependencies') +
            ...
            if (!wroteAnything) {
                // eslint-disable-next-line no-console
                console.log(terminal_1.Colorize.green('Everything looks good.') + '  No missing or unused dependencies were found.');
            }
        }
    }
}
