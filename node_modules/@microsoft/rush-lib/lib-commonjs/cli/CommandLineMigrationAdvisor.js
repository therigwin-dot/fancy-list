...
class CommandLineMigrationAdvisor {
    ...
    static _reportDeprecated(message) {
        ...
        console.error(terminal_1.Colorize.red(terminal_1.PrintUtilities.wrapWords('ERROR: You specified an outdated command-line that is no longer supported by this version of Rush:')));
        // eslint-disable-next-line no-console
        console.error(terminal_1.Colorize.yellow(terminal_1.PrintUtilities.wrapWords(message)));
        // eslint-disable-next-line no-console
        console.error();
        // eslint-disable-next-line no-console
