...
import { FileSystem, JsonFile, PackageJsonLookup, Async } from '@rushstack/node-core-library';
 ...
 */ export class SpDevDeploy {
    ...
    preProcess() {
        ...
        // this deploy fails
        FileSystem.deleteFile(metadataFilePath);
    }
    async getFilesAsync() {
    ...
    _saveDevDeployMetadata() {
        ...
        JsonFile.save(this._devDeployMetadata, dropPath, {
   ...
   */ _getDestinationDirName(directoryMap, filesystemPath) {
    ...
    _getRushConfig() {
        if (!this._rushConfig) {
            this._rushConfig = RushConfiguration.loadFromDefaultLocation();
        }
