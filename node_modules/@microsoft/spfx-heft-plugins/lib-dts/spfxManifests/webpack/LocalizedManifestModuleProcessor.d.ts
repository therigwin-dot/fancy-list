...
import type { WebpackAssets } from '../../plugins/webpackConfigurationPlugin/webpackPlugins/webpackTypes';
/**
 * @internal
 */
export type LocalizedPaths = Record<string, string | IIntegrityPath | undefined>;
/**
 * @internal
 */
 ...
 * @internal
 */
export type IGenerateLocalizedManifestModuleOptions = IGenerateLocalizedManifestModuleGenerateIntegrityOptions | IGenerateLocalizedManifestModuleExistingIntegrityOptions;
/**
 * @internal
 */
