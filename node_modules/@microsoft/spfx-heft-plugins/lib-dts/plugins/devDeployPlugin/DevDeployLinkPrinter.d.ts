...
export interface IPrintDevDeployLinkOptions {
    terminal: ITerminal;
    metadata: IDevDeployMetadata;
 ...
 */
export declare function printDevDeployLink(options: IPrintDevDeployLinkOptions): void;
//# sourceMappingURL=DevDeployLinkPrinter.d.ts.map