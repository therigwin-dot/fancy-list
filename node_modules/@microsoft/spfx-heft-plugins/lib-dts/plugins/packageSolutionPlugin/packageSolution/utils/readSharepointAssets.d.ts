...
import type { ISharepointAssets } from '../models/packageXml/ISharepointAssets';
/**
 ...
 * the SPPKG.
 */
export declare function readSharepointAssets(terminal: ITerminal, assets: ISharepointAssets<string>, featureId: string): ISharepointAssets<IFile>;
