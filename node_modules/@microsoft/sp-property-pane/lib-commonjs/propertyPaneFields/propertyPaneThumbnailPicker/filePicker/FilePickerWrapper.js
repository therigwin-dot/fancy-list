...
var FilePickerWrapper = /** @class */ (function () {
    ...
    FilePickerWrapper.prototype._startUpload = function (file) {
        ...
        if (file instanceof File) {
            ...
            uploadPromise = this._spFileHandlerPromise.then(function (fileHandler) {
                return fileHandler.uploadExternalFile(file.src, (0, Flights_1.isImagesODBFilePickerEnabled)() ? sp_file_handler_1.SPFileHandler.replaceSpecialCharacters(file.name) : file.name);
            });
        }
