...
var IconPickerPreview = /** @class */ (function (_super) {
    ...
    IconPickerPreview.prototype.render = function () {
        return (React.createElement("div", { className: IconPickerPreview_module_scss_1.default.root },
            ...
            (0, ThumbnailPickerUtils_1.getIconPickerButtons)(this._handleClick, this.props.onItemDeleted, IconPickerPreview_module_scss_1.default.changeButton, 'iconPicker', this.props.disabled),
            React.createElement(IconPicker_1.IconPicker, { ref: this._setInstanceRef, onSelect: this.props.onItemChanged, customIconSet: this.props.customIconSet, _extendedIcons: this.props._extendedIcons })));
    };
