...
function getIconPickerButtons(handleChangeIconClick, onItemDeleted, buttonClassName, automationIdPrefix, disabled) {
    ...
    }, onItemDeleted, disabled, buttonClassName, automationIdPrefix);
}
exports.getIconPickerButtons = getIconPickerButtons;
function getThumbnailPickerButtons(handleChangeImageClick, onItemDeleted, buttonClassName, disabled, automationIdPrefix) {
...
function getPickerButtons(handleChangeImageClick, buttonAriaProps, onItemDeleted, disabled, buttonClassName, automationIdPrefix) {
    ...
    var changeButtonProps = {
        ...
        disabled: disabled && !(0, KillSwitches_1.isAllowDisableThumbnailPickerKSActivated)(),
    ...
    var changeButton = (React.createElement(office_ui_fabric_react_bundle_1.ActionButton, tslib_1.__assign({}, changeButtonProps, { iconProps: {
            iconName: 'Edit'
        } }), PropertyPaneThumbnailStrings_resx_1.default.PropertyPaneChangeButtonLabel));
    var deleteButton = onItemDeleted ? (React.createElement(office_ui_fabric_react_bundle_1.ActionButton, { iconProps: { iconName: 'Delete' }, className: buttonClassName, onClick: onItemDeleted, disabled: disabled && !(0, KillSwitches_1.isAllowDisableThumbnailPickerKSActivated)(), ariaLabel: deleteButtonLabel, ariaDescription: deleteButtonDescription, "data-automation-id": automationIdPrefix ? "".concat(automationIdPrefix, "DeleteButton") : 'thumbnailImagePickerDeleteButton' }, PropertyPaneThumbnailStrings_resx_1.default.PropertyPaneDeleteButtonLabel)) : undefined;
    if (deleteButton) {
