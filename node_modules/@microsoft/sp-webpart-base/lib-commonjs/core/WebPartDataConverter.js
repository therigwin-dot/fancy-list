...
var WebPartDataConverter = /** @class */ (function () {
    ...
    WebPartDataConverter.convertServerProcessedDataToHtml = function (serverContent) {
        ...
        if (serverContent) {
            if (serverContent.htmlStrings) {
                result += WebPartDataConverter._convertServerProcessedDataToHtmlByType(serverContent.htmlStrings, sp_component_base_1.ServerProcessedDataType.htmlString);
            }
            if (serverContent.searchablePlainTexts) {
                result += WebPartDataConverter._convertServerProcessedDataToHtmlByType(serverContent.searchablePlainTexts, sp_component_base_1.ServerProcessedDataType.searchablePlainText);
            }
            if (serverContent.links) {
                result += WebPartDataConverter._convertServerProcessedDataToHtmlByType(serverContent.links, sp_component_base_1.ServerProcessedDataType.link);
            }
            if (serverContent.imageSources) {
                result += WebPartDataConverter._convertServerProcessedDataToHtmlByType(serverContent.imageSources, sp_component_base_1.ServerProcessedDataType.imageSource);
            }
        }
        return result;
    };
    ...
    WebPartDataConverter._getHtmlString = function (propName, propType, propValue) {
        ...
        if (propName && typeof propValue === 'string' && propValue) {
            switch (propType) {
                case sp_component_base_1.ServerProcessedDataType.htmlString:
                    ...
                    break;
                case sp_component_base_1.ServerProcessedDataType.searchablePlainText:
                    ...
                    break;
                case sp_component_base_1.ServerProcessedDataType.link:
                    ...
                    break;
                case sp_component_base_1.ServerProcessedDataType.imageSource:
