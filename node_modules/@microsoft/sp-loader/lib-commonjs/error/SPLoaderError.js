...
})(SPLoaderErrorCode || (exports.SPLoaderErrorCode = SPLoaderErrorCode = {}));
/**
 * sp-loader errors.
 *
 * @internal
...
var SPLoaderError = /** @class */ (function (_super) {
    ...
    SPLoaderError._errorCodeToMessageMap = new Map([
        [SPLoaderErrorCode.loadComponentMaxRetriesError, Common_resx_1.default.loadComponentMaxRetriesError],
        [SPLoaderErrorCode.loadComponentError, Error_resx_1.default.loadComponentError],
        [SPLoaderErrorCode.loadComponentReturnsEmptyError, Error_resx_1.default.loadComponentReturnsEmptyError],
        [
            SPLoaderErrorCode.loadComponentReturnsDefaultEmptyError,
            Error_resx_1.default.loadComponentReturnsDefaultEmptyError
        ],
        [SPLoaderErrorCode.loadComponentDependencyError, Error_resx_1.default.loadComponentDependencyError],
        [SPLoaderErrorCode.manifestNotFoundError, Common_resx_1.default.manifestNotFoundError],
        [
            SPLoaderErrorCode.loadPathDependencyBlockedByAnotherDependencyError,
            Error_resx_1.default.loadPathDependencyBlockedByAnotherDependencyError
        ],
        [SPLoaderErrorCode.moduleHasUndeclaredDependencyError, Error_resx_1.default.moduleHasUndeclaredDependencyError],
        [SPLoaderErrorCode.loadEntryPointError, Error_resx_1.default.loadEntryPointError],
        [SPLoaderErrorCode.loadPathDependencyError, Error_resx_1.default.loadPathDependencyError],
        [
            SPLoaderErrorCode.loadComponentDependencyFailoverPathError,
            Error_resx_1.default.loadComponentDependencyFailoverPathError
        ],
        [SPLoaderErrorCode.loadScriptWithStringError, Error_resx_1.default.loadScriptWithStringError],
        [SPLoaderErrorCode.urlStatusLocalhostFileNotFoundError, Error_resx_1.default.urlStatusLocalhostFileNotFoundError],
        [SPLoaderErrorCode.urlStatusFileNotFoundError, Error_resx_1.default.urlStatusFileNotFoundError],
        [SPLoaderErrorCode.urlStatusForbiddenError, Error_resx_1.default.urlStatusForbiddenError],
        [SPLoaderErrorCode.urlStatusClientErrorError, Error_resx_1.default.urlStatusClientErrorError],
        [SPLoaderErrorCode.urlStatusServerErrorError, Error_resx_1.default.urlStatusServerErrorError],
        [SPLoaderErrorCode.urlStatusLocalhostNetworkErrorError, Error_resx_1.default.urlStatusLocalhostNetworkErrorError],
        // Note that the doclib error shows the standard network error message
        [SPLoaderErrorCode.urlStatusDocLibNetworkErrorError, Error_resx_1.default.urlStatusNetworkErrorError],
        [SPLoaderErrorCode.urlStatusHttpsNetworkErrorError, Error_resx_1.default.urlStatusHttpsNetworkErrorError],
        [SPLoaderErrorCode.urlStatusNetworkErrorError, Error_resx_1.default.urlStatusNetworkErrorError],
        [SPLoaderErrorCode.urlStatusUndefinedError, Error_resx_1.default.urlStatusUndefinedError],
        [SPLoaderErrorCode.failedToCreateGlobalVariable, Error_resx_1.default.failedToCreateGlobalVariableError],
        [SPLoaderErrorCode.dependencyLoadError, Error_resx_1.default.dependencyLoadError],
        [SPLoaderErrorCode.missingPathDependencyError, Error_resx_1.default.missingPathDependencyError]
