...
(function() {
  ...
  __exec = function(load) {
    // SPFx - Fix from https://github.com/systemjs/systemjs/commit/8d64131a03ad171b452d83dcda59a574ee27e037
	if (!load.source)
		return;
  ...
  return function(load) {
    ...
    if (load.metadata.format == 'global' && !load.metadata.registered) {
      ...
      entry.execute = function(require, exports, module) {
		...
		// SPFx - Fix for: If eval'ing the script fails, window.define is undefined
		try {
			__exec.call(loader, load);
		} catch (error) {
			retrieveGlobal();
...
System.version = '0.19.25 for SPFx';
  // -- exporting --
