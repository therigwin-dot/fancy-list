...
export var TitleConfiguration = function (_a) {
    ...
    return (React.createElement("div", { style: { marginBottom: 16 } },
        ...
        React.createElement("div", { style: { display: 'flex', gap: '16px', marginBottom: 16 } },
            React.createElement(Toggle, { label: "Title Divider", checked: settings.showDivider, onText: "On", offText: "Off", onChange: function (_, checked) { return handlePropertyChange('showDivider', checked); } })),
        React.createElement("div", { style: { marginBottom: 16 } },
