    ...
    return (React.createElement("div", { style: { marginBottom: 16 } },
        ...
        enabled && (React.createElement(React.Fragment, null,
            ...
            React.createElement("div", { style: {
                ...
                React.createElement(TextField, { value: settings.webPartTitle, onChange: function (_, newValue) { return handlePropertyChange('webPartTitle', newValue !== null && newValue !== void 0 ? newValue : ''); }, placeholder: "Enter title text", styles: { root: { flex: '1 1 auto' } } }),
            ...
            React.createElement("div", { style: { marginBottom: 16 } },
                React.createElement(DivideSpaceControl, { label: "Divide Space", value: settings.divideSpace, onChange: function (value) { return handlePropertyChange('divideSpace', value); }, onReset: function () { return handlePropertyChange('divideSpace', DEFAULTS_CONFIG.titleSettings.divideSpace); }, onTestValues: function () { return handlePropertyChange('divideSpace', DEFAULTS_CONFIG.titleSettings.testValues.divideSpace); } })),
            React.createElement("div", { style: { marginTop: 16, display: 'flex', gap: '8px' } },
                ...
                React.createElement(PrimaryButton, { text: DEFAULTS_CONFIG.titleSettings.testValuesButtonText, onClick: handleTestValues }))))));
};
