...
export var FontControl = function (_a) {
    ...
    return (React.createElement("div", { style: { marginBottom: 16 } },
        ...
        React.createElement("div", { style: {
            ...
            React.createElement(ComboBox, { label: undefined, ariaLabel: "Font Size", options: FONT_SIZES, selectedKey: fontSize || '24px', allowFreeform: true, autoComplete: "on", onChange: function (_, option, __, textValue) {
                    if (option) {
