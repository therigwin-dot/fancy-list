...
export var FontControl = function (_a) {
    ...
    return (React.createElement("div", { style: { marginBottom: 16 } },
        ...
        React.createElement("div", { style: {
            ...
            React.createElement(ComboBox, { label: undefined, ariaLabel: "Font Size", options: FONT_SIZES, selectedKey: isEditing ? undefined : (fontSize || '24px'), text: isEditing ? '' : (fontSize || '24px'), allowFreeform: true, autoComplete: "on", onFocus: function () {
                    setIsEditing(true);
                }, onBlur: function () {
