...
export var FontControl = function (_a) {
    ...
    return (React.createElement("div", { style: { marginBottom: 16 } },
        ...
        React.createElement("div", { style: {
            ...
            React.createElement(Dropdown, { label: undefined, ariaLabel: "Font Family", options: FONT_FAMILIES, selectedKey: fontFamily || 'Segoe UI', onChange: function (_, option) { return onChange({ fontFamily: option.key }); }, onRenderOption: renderFontOption, onRenderTitle: renderFontTitle, styles: { root: { minWidth: 140, flex: '1 1 auto' } } }),
            ...
            React.createElement(Dropdown, { label: undefined, ariaLabel: "Font Size", options: FONT_SIZES, selectedKey: fontSize || '24px', onChange: function (_, option) { return onChange({ fontSize: option.key }); }, styles: { root: { width: 120, flex: '0 0 auto' } } }))));
};
