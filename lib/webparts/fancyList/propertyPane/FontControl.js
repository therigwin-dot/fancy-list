...
import { Dropdown, IconButton, Stack, Text, TooltipHost } from '@fluentui/react';
var FONT_FAMILIES = [
...
export var FontControl = function (_a) {
    ...
    return (React.createElement(Stack, { tokens: { childrenGap: 8 }, style: { marginBottom: 16 } },
        label && React.createElement(Text, { variant: "mediumPlus", styles: { root: { fontWeight: 600, marginBottom: 4 } } }, label),
        React.createElement(Stack, { horizontal: true, verticalAlign: "center", tokens: { childrenGap: 4 } },
            ...
            React.createElement(Dropdown, { label: undefined, ariaLabel: "Font Size", options: FONT_SIZES, selectedKey: fontSize || '24px', onChange: function (_, option) { return onChange({ fontSize: option.key }); }, styles: { root: { width: 140, marginLeft: 8 } } })),
        React.createElement(Dropdown, { label: undefined, ariaLabel: "Font Family", options: FONT_FAMILIES, selectedKey: fontFamily || 'Segoe UI', onChange: function (_, option) { return onChange({ fontFamily: option.key }); }, onRenderOption: renderFontOption, onRenderTitle: renderFontTitle, styles: { root: { maxWidth: 260 } } })));
};
