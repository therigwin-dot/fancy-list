...
export var SectionModuleControl = function (_a) {
    ...
    return (React.createElement("div", { style: { marginBottom: 16 } },
        ...
        React.createElement("div", { style: { marginBottom: 16 } },
            React.createElement(DivideSpaceControl, { label: "Div Space", value: sectionSettings.divideSpace, onChange: function (value) { return handlePropertyChange('divideSpace', value); } })),
        React.createElement("div", { style: { marginTop: 16, display: 'flex', gap: '8px' } },
            ...
            React.createElement(PrimaryButton, { text: "Apply MFB Theme", onClick: handleTestValues }))));
};
