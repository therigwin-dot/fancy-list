...
export var ColorPickerControl = function (_a) {
    ...
    return (React.createElement("div", { style: { marginBottom: 12 } },
        ...
        React.createElement("div", { style: { display: 'flex', alignItems: 'center', gap: 1 } },
            ...
            React.createElement(TextField, { value: currentColor, onChange: handleHexChange, disabled: disabled, styles: { root: { width: 70 } }, placeholder: "#RRGGBB", title: "Type a hex color code (e.g., #ff0000 for red)" }),
