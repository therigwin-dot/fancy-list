...
export var IconControl = function (_a) {
    ...
    return (React.createElement("div", { style: { marginBottom: 16 } },
        ...
        React.createElement("div", { style: { marginBottom: 16 } },
            React.createElement(Toggle, { label: "Enable Icons", checked: settings.enabled, onText: "On", offText: "Off", onChange: function (_, checked) { return handlePropertyChange('enabled', checked); } })),
        settings.enabled && (React.createElement(React.Fragment, null,
            React.createElement("div", { style: { marginBottom: 16 } },
                React.createElement(Dropdown, { label: "Icon Position", options: positionOptions, selectedKey: settings.iconPosition, onChange: function (_, option) { return handlePropertyChange('iconPosition', option === null || option === void 0 ? void 0 : option.key); } })),
            React.createElement("div", { style: { marginBottom: 16 } },
                React.createElement("div", { style: { display: 'flex', alignItems: 'flex-end', gap: '8px' } },
                    React.createElement("div", { style: { flex: 1 } },
                        React.createElement(ComboBox, { label: "Collapsed Icon", options: collapsedIconOptions, text: settings.collapsedIcon, allowFreeform: true, autoComplete: "on", onChange: function (_, option, __, text) {
                                if (option) {
                    ...
                    React.createElement(IconButton, { iconProps: { iconName: 'Emoji2' }, title: "Open emoji picker", onClick: function () { return openEmojiPicker('collapsed'); }, style: { marginBottom: '8px' } }))),
            React.createElement("div", { style: { marginBottom: 16 } },
                React.createElement("div", { style: { display: 'flex', alignItems: 'flex-end', gap: '8px' } },
                    React.createElement("div", { style: { flex: 1 } },
                        React.createElement(ComboBox, { label: "Expanded Icon", options: expandedIconOptions, text: settings.expandedIcon, allowFreeform: true, autoComplete: "on", onChange: function (_, option, __, text) {
                                if (option) {
                    ...
                    React.createElement(IconButton, { iconProps: { iconName: 'Emoji2' }, title: "Open emoji picker", onClick: function () { return openEmojiPicker('expanded'); }, style: { marginBottom: '8px' } }))))),
