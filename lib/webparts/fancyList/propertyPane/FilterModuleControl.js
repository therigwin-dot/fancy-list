...
export var FilterModuleControl = function (_a) {
    ...
    var _e = React.useState((_b = settings === null || settings === void 0 ? void 0 : settings.enableFilters) !== null && _b !== void 0 ? _b : true), enabled = _e[0], setEnabled = _e[1];
    var _f = React.useState((_c = settings === null || settings === void 0 ? void 0 : settings.showAllCategories) !== null && _c !== void 0 ? _c : true), showAllToggle = _f[0], setShowAllToggle = _f[1];
    var _g = React.useState('#ffffff'), previewColor1 = _g[0], setPreviewColor1 = _g[1];
    var _h = React.useState('#000000'), previewColor2 = _h[0], setPreviewColor2 = _h[1];
