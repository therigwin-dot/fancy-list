...
export var FilterModuleControl = function (_a) {
    ...
    var _d = React.useState('#ffffff'), previewColor1 = _d[0], setPreviewColor1 = _d[1];
    var _e = React.useState('#000000'), previewColor2 = _e[0], setPreviewColor2 = _e[1];
    ...
    return (React.createElement("div", { style: { marginBottom: 16 } },
        ...
        enabled && (React.createElement(React.Fragment, null,
            ...
            React.createElement("div", { style: { marginBottom: 16 } },
                React.createElement(Toggle, { label: "Filter Divider", inlineLabel: true, checked: settings.showDivider, onText: "On", offText: "Off", onChange: function (_, checked) { return handlePropertyChange('showDivider', checked); } })),
