...
export var FilterModuleControl = function (_a) {
    ...
    var _g = React.useState((_b = settings === null || settings === void 0 ? void 0 : settings.enableFilters) !== null && _b !== void 0 ? _b : true), enabled = _g[0], setEnabled = _g[1];
    var _h = React.useState((_c = settings === null || settings === void 0 ? void 0 : settings.showAllCategories) !== null && _c !== void 0 ? _c : true), showAllToggle = _h[0], setShowAllToggle = _h[1];
    var _j = React.useState((_d = settings === null || settings === void 0 ? void 0 : settings.defaultFilterSelection) !== null && _d !== void 0 ? _d : 'All'), defaultFilterDropdown = _j[0], setDefaultFilterDropdown = _j[1];
    ...
    var _k = React.useState('#ffffff'), previewColor1 = _k[0], setPreviewColor1 = _k[1];
    var _l = React.useState('#000000'), previewColor2 = _l[0], setPreviewColor2 = _l[1];
    ...
    return (React.createElement("div", { style: { marginBottom: 16 } },
        ...
        React.createElement("div", { style: {
            ...
            enabled && (React.createElement("div", { style: { marginBottom: 16 } },
        ...
        enabled && (React.createElement(React.Fragment, null,
            ...
            React.createElement(DivideSpaceControl, { label: "Div Space", value: settings.divideSpace, onChange: function (value) { return handlePropertyChange('divideSpace', value); }, onReset: function () { return handlePropertyChange('divideSpace', DEFAULTS_CONFIG.filterSettings.divideSpace); }, onTestValues: function () { return handlePropertyChange('divideSpace', DEFAULTS_CONFIG.filterSettings.testValues.divideSpace); } }),
            React.createElement("div", { style: { marginTop: 16, display: 'flex', gap: '8px' } },
                React.createElement(PrimaryButton, { text: DEFAULTS_CONFIG.filterSettings.resetButtonText, onClick: function () {
                ...
                React.createElement(PrimaryButton, { text: DEFAULTS_CONFIG.filterSettings.testValuesButtonText, onClick: function () {
                        // Apply test values
