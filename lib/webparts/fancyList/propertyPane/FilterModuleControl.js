...
export var FilterModuleControl = function (_a) {
    ...
    var _d = React.useState((_b = settings === null || settings === void 0 ? void 0 : settings.enableFilters) !== null && _b !== void 0 ? _b : true), enabled = _d[0], setEnabled = _d[1];
    var _e = React.useState('#ffffff'), previewColor1 = _e[0], setPreviewColor1 = _e[1];
    var _f = React.useState('#000000'), previewColor2 = _f[0], setPreviewColor2 = _f[1];
    ...
    return (React.createElement("div", { style: { marginBottom: 16 } },
        ...
        enabled && (React.createElement(React.Fragment, null,
            React.createElement("div", { style: {
                ...
                React.createElement("div", { style: { marginBottom: 16 } },
                    React.createElement(Toggle, { label: "Show 'All' Filter Button", inlineLabel: true, checked: settings.showAllCategories || false, onText: "On", offText: "Off", onChange: function (_, checked) { return handlePropertyChange('showAllCategories', checked); } }))),
            React.createElement("div", { style: {
                    backgroundColor: '#f3f2f1',
                    padding: '12px',
                    borderRadius: '4px',
