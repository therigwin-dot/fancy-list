...
export var FilterModuleControl = function (_a) {
    ...
    var _c = React.useState(true), enabled = _c[0], setEnabled = _c[1];
    ...
    return (React.createElement("div", { style: { marginBottom: 16 } },
        ...
        React.createElement("div", { style: { display: 'flex', gap: '16px', marginBottom: 16 } },
            React.createElement(Toggle, { label: "Enabled", checked: enabled, onText: "On", offText: "Off", onChange: function (_, checked) {
        ...
        enabled && (React.createElement(React.Fragment, null,
            ...
            React.createElement("div", { style: { display: 'flex', gap: '16px', marginBottom: 16 } },
                React.createElement(Toggle, { label: "Filter Divider", checked: settings.showDivider, onText: "On", offText: "Off", onChange: function (_, checked) { return handlePropertyChange('showDivider', checked); } })),
