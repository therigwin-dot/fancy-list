...
export var DivideSpaceControl = function (_a) {
    ...
    return (React.createElement("div", { style: { marginBottom: 16 } },
        ...
        isCustom && (React.createElement("div", { style: { marginBottom: 8 } },
            React.createElement(TextField, { label: "Custom Value (px)", value: customValue, onChange: function (_, newValue) { return handleCustomValueChange(newValue || ''); }, placeholder: "0-50", errorMessage: validateDivideSpace(customValue) || undefined, type: "number", min: 0, max: 50 }))),
