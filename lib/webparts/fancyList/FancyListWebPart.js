                                        ...
                                        onRender: function (elem, ctx, changeCallback) {
                                            ...
                                            ReactDom.render(React.createElement(FilterModuleControl, {
                                                ...
                                                settings: {
                                                    ...
                                                    showDivider: ((_q = _this.properties.filterSettings) === null || _q === void 0 ? void 0 : _q.showDivider) || DEFAULTS_CONFIG.filterSettings.showDivider,
                                                    backgroundType: ((_r = _this.properties.filterSettings) === null || _r === void 0 ? void 0 : _r.background.type) || DEFAULTS_CONFIG.filterSettings.background.type,
                                                    backgroundColor: ((_s = _this.properties.filterSettings) === null || _s === void 0 ? void 0 : _s.background.color) || DEFAULTS_CONFIG.filterSettings.background.color,
                                                    backgroundAlpha: ((_t = _this.properties.filterSettings) === null || _t === void 0 ? void 0 : _t.background.alpha) || DEFAULTS_CONFIG.filterSettings.background.alpha,
                                                    gradientDirection: ((_u = _this.properties.filterSettings) === null || _u === void 0 ? void 0 : _u.background.gradientDirection) || DEFAULTS_CONFIG.filterSettings.background.gradientDirection,
                                                    gradientColor1: ((_v = _this.properties.filterSettings) === null || _v === void 0 ? void 0 : _v.background.gradientColor1) || DEFAULTS_CONFIG.filterSettings.background.gradientColor1,
                                                    gradientColor2: ((_w = _this.properties.filterSettings) === null || _w === void 0 ? void 0 : _w.background.gradientColor2) || DEFAULTS_CONFIG.filterSettings.background.gradientColor2,
                                                    gradientAlpha: ((_x = _this.properties.filterSettings) === null || _x === void 0 ? void 0 : _x.background.gradientAlpha1) || DEFAULTS_CONFIG.filterSettings.background.gradientAlpha1,
                                                    imageUrl: ((_y = _this.properties.filterSettings) === null || _y === void 0 ? void 0 : _y.background.image) || DEFAULTS_CONFIG.filterSettings.background.image,
                                                    imageAlpha: ((_z = _this.properties.filterSettings) === null || _z === void 0 ? void 0 : _z.background.imageAlpha) || DEFAULTS_CONFIG.filterSettings.background.imageAlpha
                                                },
                                                onPropertyChange: function (propertyPath, newValue) {
                                                    // Handle property changes and update the web part properties
