                                    ...
                                    properties: {
                                        ...
                                        onRender: function (elem, ctx, changeCallback) {
                                            ReactDom.render(React.createElement('div', {
                                                ...
                                                }, "Version: ".concat(DEFAULTS_CONFIG.aboutInfo.version)),
                                                // Description
                                                React.createElement('div', {
                                                    key: 'description',
                                                    style: {
                                            ...
                                            ], DEFAULTS_CONFIG.aboutInfo.features.map(function (feature, index) {
                                            ...
                                            ], false), DEFAULTS_CONFIG.aboutInfo.knownIssues.map(function (issue, index) {
                                                return React.createElement('div', {
