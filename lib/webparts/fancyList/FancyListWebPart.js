                        ...
                        },
                        {
                            ...
                            groupFields: [
                                ...
                                PropertyPaneLabel('features10', {
                                    text: "\u2022 ".concat(DEFAULTS_CONFIG.aboutInfo.features[9])
                                }),
                                PropertyPaneLabel('features11', {
                                    text: "\u2022 ".concat(DEFAULTS_CONFIG.aboutInfo.features[10])
                                }),
                                PropertyPaneLabel('features12', {
                                    text: "\u2022 ".concat(DEFAULTS_CONFIG.aboutInfo.features[11])
                                }),
                                PropertyPaneLabel('features13', {
                                    text: "\u2022 ".concat(DEFAULTS_CONFIG.aboutInfo.features[12])
                                }),
                                PropertyPaneLabel('features14', {
                                    text: "\u2022 ".concat(DEFAULTS_CONFIG.aboutInfo.features[13])
                                }),
                                PropertyPaneLabel('features15', {
                                    text: "\u2022 ".concat(DEFAULTS_CONFIG.aboutInfo.features[14])
                                }),
                                PropertyPaneLabel('features16', {
                                    text: "\u2022 ".concat(DEFAULTS_CONFIG.aboutInfo.features[15])
                                }),
                                PropertyPaneLabel('features17', {
                                    text: "\u2022 ".concat(DEFAULTS_CONFIG.aboutInfo.features[16])
                                }),
                                PropertyPaneLabel('features18', {
                                    text: "\u2022 ".concat(DEFAULTS_CONFIG.aboutInfo.features[17])
                                }),
                                PropertyPaneLabel('features19', {
                                    text: "\u2022 ".concat(DEFAULTS_CONFIG.aboutInfo.features[18])
                                }),
                                PropertyPaneLabel('features20', {
                                    text: "\u2022 ".concat(DEFAULTS_CONFIG.aboutInfo.features[19])
                                })
                            ]
                        },
                        {
                            ...
                            groupFields: [
                                ...
                                PropertyPaneLabel('knownIssues3', {
                                    text: "\u2022 ".concat(DEFAULTS_CONFIG.aboutInfo.knownIssues[2])
                                }),
                                PropertyPaneLabel('knownIssues4', {
                                    text: "\u2022 ".concat(DEFAULTS_CONFIG.aboutInfo.knownIssues[3])
                                }),
                                PropertyPaneLabel('knownIssues5', {
                                    text: "\u2022 ".concat(DEFAULTS_CONFIG.aboutInfo.knownIssues[4])
                                })
                            ]
                        }
                    ]
