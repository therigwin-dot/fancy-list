                                        ...
                                        onRender: function (elem, ctx, changeCallback) {
                                            ...
                                            ReactDom.render(React.createElement(FilterModuleControl, {
                                                ...
                                                settings: {
                                                    ...
                                                    showAllCategories: ((_o = _this.properties.filterSettings) === null || _o === void 0 ? void 0 : _o.showAllCategories) || DEFAULTS_CONFIG.filterSettings.showAllCategories,
                                                    showDivider: ((_p = _this.properties.filterSettings) === null || _p === void 0 ? void 0 : _p.showDivider) || DEFAULTS_CONFIG.filterSettings.showDivider,
                                                    backgroundType: ((_q = _this.properties.filterSettings) === null || _q === void 0 ? void 0 : _q.background.type) || DEFAULTS_CONFIG.filterSettings.background.type,
                                                    backgroundColor: ((_r = _this.properties.filterSettings) === null || _r === void 0 ? void 0 : _r.background.color) || DEFAULTS_CONFIG.filterSettings.background.color,
                                                    backgroundAlpha: ((_s = _this.properties.filterSettings) === null || _s === void 0 ? void 0 : _s.background.alpha) || DEFAULTS_CONFIG.filterSettings.background.alpha,
                                                    gradientDirection: ((_t = _this.properties.filterSettings) === null || _t === void 0 ? void 0 : _t.background.gradientDirection) || DEFAULTS_CONFIG.filterSettings.background.gradientDirection,
                                                    gradientColor1: ((_u = _this.properties.filterSettings) === null || _u === void 0 ? void 0 : _u.background.gradientColor1) || DEFAULTS_CONFIG.filterSettings.background.gradientColor1,
                                                    gradientColor2: ((_v = _this.properties.filterSettings) === null || _v === void 0 ? void 0 : _v.background.gradientColor2) || DEFAULTS_CONFIG.filterSettings.background.gradientColor2,
                                                    gradientAlpha: ((_w = _this.properties.filterSettings) === null || _w === void 0 ? void 0 : _w.background.gradientAlpha1) || DEFAULTS_CONFIG.filterSettings.background.gradientAlpha1,
                                                    imageUrl: ((_x = _this.properties.filterSettings) === null || _x === void 0 ? void 0 : _x.background.image) || DEFAULTS_CONFIG.filterSettings.background.image,
                                                    imageAlpha: ((_y = _this.properties.filterSettings) === null || _y === void 0 ? void 0 : _y.background.imageAlpha) || DEFAULTS_CONFIG.filterSettings.background.imageAlpha
                                                },
                                                onPropertyChange: function (propertyPath, newValue) {
                                                    // Handle property changes and update the web part properties
