                                        ...
                                        onRender: function (elem, ctx, changeCallback) {
                                            ...
                                            ReactDom.render(React.createElement(FilterModuleControl, {
                                                ...
                                                settings: {
                                                    ...
                                                    showDivider: ((_j = _this.properties.filterSettings) === null || _j === void 0 ? void 0 : _j.showDivider) || DEFAULTS_CONFIG.filterSettings.showDivider,
                                                    backgroundType: ((_k = _this.properties.filterSettings) === null || _k === void 0 ? void 0 : _k.background.type) || DEFAULTS_CONFIG.filterSettings.background.type,
                                                    backgroundColor: ((_l = _this.properties.filterSettings) === null || _l === void 0 ? void 0 : _l.background.color) || DEFAULTS_CONFIG.filterSettings.background.color,
                                                    backgroundAlpha: ((_m = _this.properties.filterSettings) === null || _m === void 0 ? void 0 : _m.background.alpha) || DEFAULTS_CONFIG.filterSettings.background.alpha,
                                                    gradientDirection: ((_o = _this.properties.filterSettings) === null || _o === void 0 ? void 0 : _o.background.gradientDirection) || DEFAULTS_CONFIG.filterSettings.background.gradientDirection,
                                                    gradientColor1: ((_p = _this.properties.filterSettings) === null || _p === void 0 ? void 0 : _p.background.gradientColor1) || DEFAULTS_CONFIG.filterSettings.background.gradientColor1,
                                                    gradientColor2: ((_q = _this.properties.filterSettings) === null || _q === void 0 ? void 0 : _q.background.gradientColor2) || DEFAULTS_CONFIG.filterSettings.background.gradientColor2,
                                                    gradientAlpha: ((_r = _this.properties.filterSettings) === null || _r === void 0 ? void 0 : _r.background.gradientAlpha1) || DEFAULTS_CONFIG.filterSettings.background.gradientAlpha1,
                                                    imageUrl: ((_s = _this.properties.filterSettings) === null || _s === void 0 ? void 0 : _s.background.image) || DEFAULTS_CONFIG.filterSettings.background.image,
                                                    imageAlpha: ((_t = _this.properties.filterSettings) === null || _t === void 0 ? void 0 : _t.background.imageAlpha) || DEFAULTS_CONFIG.filterSettings.background.imageAlpha
                                                },
                                                onPropertyChange: function (propertyPath, newValue) {
                                                    // Handle property changes and update the web part properties
