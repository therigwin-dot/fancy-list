            ...
            React.createElement("div", { className: styles.itemsContainer }, this.getFilteredItems().map(function (item) {
                ...
                return (React.createElement("div", { key: item.id, className: styles.itemPanel },
                    React.createElement("button", { className: styles.itemHeader, onClick: function () { return _this.handleItemToggle(item.id); }, "aria-expanded": _this.state.expandedItems.has(item.id) ? "true" : "false" },
                        ...
                        ((_b = (_a = _this.props.categorySectionSettings) === null || _a === void 0 ? void 0 : _a.icons) === null || _b === void 0 ? void 0 : _b.enabled) && (React.createElement("span", { className: styles.expandIcon }, _this.state.expandedItems.has(item.id) ? '−' : '+'))),
