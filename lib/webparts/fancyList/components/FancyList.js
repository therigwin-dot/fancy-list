    ...
    FancyList.prototype.render = function () {
        ...
        return (React.createElement("div", { className: styles.fancyList },
            ...
            ((_d = this.props.filterSettings) === null || _d === void 0 ? void 0 : _d.enableFilters) && (React.createElement(React.Fragment, null,
                React.createElement("div", { className: styles.categoryFilters, style: __assign(__assign({}, this.getFilterBackgroundStyle(this.props.filterSettings)), { position: 'relative', padding: '12px', marginBottom: '12px', borderRadius: this.getShapeRadius(((_e = this.props.filterSettings) === null || _e === void 0 ? void 0 : _e.backgroundShape) || 'rounded') }) },
            ...
            React.createElement("div", { className: styles.itemsContainer }, Object.keys(this.groupItemsByCategory(this.getFilteredItems())).map(function (category) {
                ...
                return (React.createElement("div", { key: category, className: styles.itemPanel },
                    React.createElement("button", { className: styles.itemHeader, onClick: function () { return _this.handleCategoryToggle(category); }, "aria-expanded": _this.state.expandedCategories.has(category) ? "true" : "false", style: __assign({ display: 'flex', alignItems: 'center', justifyContent: 'space-between', width: '100%' }, _this.getCategorySectionFontStyle()) },
                        React.createElement("span", { className: styles.itemSubject }, category),
                    ...
                    _this.state.expandedCategories.has(category) && (React.createElement("div", { className: styles.itemContent }, items.map(function (item) {
                        ...
                        return (React.createElement("div", { key: item.id, className: styles.itemPanel },
                            React.createElement("button", { className: styles.itemHeader, onClick: function () { return _this.handleItemToggle(item.id); }, "aria-expanded": _this.state.expandedItems.has(item.id) ? "true" : "false", style: __assign({ display: 'flex', alignItems: 'center', justifyContent: 'space-between', width: '100%' }, _this.getSubjectSectionFontStyle()) },
