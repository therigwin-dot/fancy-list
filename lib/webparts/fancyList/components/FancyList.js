...
var FancyList = /** @class */ (function (_super) {
    ...
    FancyList.prototype.render = function () {
        ...
        var _20 = this.state, loading = _20.loading, error = _20.error, categories = _20.categories, selectedCategory = _20.selectedCategory, expandedItems = _20.expandedItems;
        ...
        return (React.createElement("div", { className: styles.fancyList },
            ...
            ((_f = this.props.filterSettings) === null || _f === void 0 ? void 0 : _f.enableFilters) && (React.createElement(React.Fragment, null,
