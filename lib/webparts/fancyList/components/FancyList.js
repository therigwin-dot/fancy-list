        ...
        if (backgroundType === 'image' && imageUrl && !this.isValidImageUrl(imageUrl)) {
            return (React.createElement("div", { style: this.getTitleStyle() },
                React.createElement("div", { style: { textAlign: 'center', padding: '8px' } },
                    React.createElement("div", { style: { color: '#d13438', fontWeight: 'bold', marginBottom: '4px' } }, "Invalid Image URL"),
                    React.createElement("div", { style: { color: '#605e5c', fontSize: '12px', lineHeight: '1.3' } }, "Please provide a valid image file (.jpg, .jpeg, .png, .gif, .webp)")),
                showDivider && React.createElement("div", { style: { height: '1px', backgroundColor: 'rgba(0, 0, 0, 0.1)', marginTop: '12px' } })));
        }
        return (React.createElement("div", { style: this.getTitleStyle() },
