                ...
                return (React.createElement("div", { key: category, className: styles.itemPanel, style: __assign(__assign({}, _this.getCategorySectionBackgroundStyle()), { marginBottom: "".concat(divideSpace, "px") }) },
                    ...
                    isCategoryExpanded && (React.createElement("div", { className: styles.itemContent }, items.map(function (item) {
                        ...
                        return (React.createElement("div", { key: item.id, className: styles.itemPanel, style: {
                            ...
                            React.createElement("button", { className: "".concat(styles.itemHeader, " ").concat(isItemExpanded ? styles.expanded : ''), onClick: function () { return _this.handleItemToggle(item.id); }, "aria-expanded": isItemExpanded ? "true" : "false", style: __assign({ display: 'flex', alignItems: 'center', justifyContent: 'space-between', width: '100%', padding: '1em' }, _this.getSubjectSectionBackgroundStyle()) },
