    ...
    FancyList.prototype.render = function () {
        ...
        return (React.createElement("div", { className: styles.fancyList },
            ...
            ((_k = this.props.filterSettings) === null || _k === void 0 ? void 0 : _k.enableFilters) && (React.createElement(React.Fragment, null,
                React.createElement("div", { className: styles.categoryFilters, style: __assign(__assign({}, this.getFilterBackgroundStyle(this.props.filterSettings)), { position: 'relative', padding: '12px', marginBottom: '12px', borderRadius: this.getShapeRadius(((_l = this.props.filterSettings) === null || _l === void 0 ? void 0 : _l.backgroundShape) || 'rounded') }) },
                    ((_o = (_m = this.props.filterSettings) === null || _m === void 0 ? void 0 : _m.background) === null || _o === void 0 ? void 0 : _o.type) === 'image' &&
                        ...
                        ((_u = (_t = this.props.filterSettings) === null || _t === void 0 ? void 0 : _t.background) === null || _u === void 0 ? void 0 : _u.imageAlpha) > 0 && (React.createElement("div", { style: {
                            position: 'absolute',
                            top: 0,
                            left: 0,
                            right: 0,
                    ...
                    React.createElement("div", { style: {
                        ...
                        ((_z = this.props.filterSettings) === null || _z === void 0 ? void 0 : _z.showAllCategories) && (React.createElement("button", { className: "".concat(styles.categoryPill, " ").concat(selectedCategory === 'all' ? styles.active : ''), style: {
                ...
                (this.state.filterImageValidationError || this.state.filterImageLoadError ||
                    (((_22 = (_21 = this.props.filterSettings) === null || _21 === void 0 ? void 0 : _21.background) === null || _22 === void 0 ? void 0 : _22.type) === 'image' && !((_24 = (_23 = this.props.filterSettings) === null || _23 === void 0 ? void 0 : _23.background) === null || _24 === void 0 ? void 0 : _24.image))) && (React.createElement("div", { style: {
                        fontSize: '12px',
                        fontFamily: 'Arial, sans-serif',
                        color: '#000000',
                        textAlign: 'right',
                    ...
                    'Please enter an image URL')),
                ((_25 = this.props.filterSettings) === null || _25 === void 0 ? void 0 : _25.showDivider) && (React.createElement("div", { style: {
                        height: '1px',
                        backgroundColor: 'rgba(0, 0, 0, 0.1)',
                        marginTop: '12px',
                        marginBottom: '12px'
