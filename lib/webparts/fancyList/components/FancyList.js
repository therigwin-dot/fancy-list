...
var FancyList = /** @class */ (function (_super) {
    ...
    FancyList.prototype.render = function () {
        ...
        return (React.createElement("div", { className: styles.fancyList },
            ...
            React.createElement("div", { className: styles.itemsContainer }, this.getFilteredItems().map(function (item) {
                var _a, _b, _c, _d;
                return (React.createElement("div", { key: item.id, className: styles.itemPanel },
                    React.createElement("button", { className: styles.itemHeader, onClick: function () { return _this.handleItemToggle(item.id); }, "aria-expanded": _this.state.expandedItems.has(item.id) ? "true" : "false", style: __assign({ display: 'flex', alignItems: 'center', justifyContent: 'space-between', width: '100%' }, _this.getCategorySectionFontStyle()) },
