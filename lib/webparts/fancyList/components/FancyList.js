...
var FancyList = /** @class */ (function (_super) {
    ...
    FancyList.prototype.getCategorySectionBackgroundStyle = function () {
        ...
        switch (backgroundType) {
            case 'solid':
                return __assign({ backgroundColor: "".concat(this.hexToRgba(backgroundColor, 1 - (backgroundAlpha / 100)), " !important"), borderRadius: this.getShapeRadius(shape) }, baseOverrides);
            case 'gradient':
                return __assign({ background: "".concat(this.getGradientStyle(gradientDirection, gradientColor1, gradientColor2, 1 - (gradientAlpha / 100)), " !important"), borderRadius: this.getShapeRadius(shape) }, baseOverrides);
            case 'image':
                if (imageUrl) {
                    return __assign({ background: "linear-gradient(rgba(255,255,255,".concat(imageAlpha / 100, "), rgba(255,255,255,").concat(imageAlpha / 100, ")), url(").concat(imageUrl, ") !important"), backgroundSize: 'cover !important', backgroundPosition: 'center !important', borderRadius: this.getShapeRadius(shape) }, baseOverrides);
                }
                else {
                    return __assign({ backgroundColor: '#ffffff !important', borderRadius: this.getShapeRadius(shape) }, baseOverrides);
                }
            default:
    ...
    FancyList.prototype.render = function () {
        ...
        return (React.createElement("div", { className: styles.fancyList },
            ...
            ((_d = this.props.titleSettings) === null || _d === void 0 ? void 0 : _d.showDivider) && (React.createElement("div", { style: {
                    height: '1px',
                    backgroundColor: 'rgba(0, 0, 0, 0.1)',
                    marginTop: '12px',
                    marginBottom: '12px'
                } })),
            ((_e = this.props.filterSettings) === null || _e === void 0 ? void 0 : _e.enableFilters) && (React.createElement(React.Fragment, null,
                React.createElement("div", { className: styles.categoryFilters, style: __assign(__assign({}, this.getFilterBackgroundStyle(this.props.filterSettings)), { position: 'relative', padding: '12px', marginBottom: '12px', borderRadius: this.getShapeRadius(((_f = this.props.filterSettings) === null || _f === void 0 ? void 0 : _f.backgroundShape) || 'rounded') }) },
                    ((_h = (_g = this.props.filterSettings) === null || _g === void 0 ? void 0 : _g.background) === null || _h === void 0 ? void 0 : _h.type) === 'image' &&
                        ...
                        ((_p = (_o = this.props.filterSettings) === null || _o === void 0 ? void 0 : _o.background) === null || _p === void 0 ? void 0 : _p.imageAlpha) > 0 && (React.createElement("div", { style: {
                            position: 'absolute',
                            top: 0,
                            left: 0,
                            right: 0,
                    ...
                    React.createElement("div", { style: {
                        ...
                        ((_u = this.props.filterSettings) === null || _u === void 0 ? void 0 : _u.showAllCategories) && (React.createElement("button", { className: "".concat(styles.categoryPill, " ").concat(selectedCategory === 'all' ? styles.active : ''), style: {
                ...
                (this.state.filterImageValidationError || this.state.filterImageLoadError ||
                    (((_17 = (_16 = this.props.filterSettings) === null || _16 === void 0 ? void 0 : _16.background) === null || _17 === void 0 ? void 0 : _17.type) === 'image' && !((_19 = (_18 = this.props.filterSettings) === null || _18 === void 0 ? void 0 : _18.background) === null || _19 === void 0 ? void 0 : _19.image))) && (React.createElement("div", { style: {
                        fontSize: '12px',
                        fontFamily: 'Arial, sans-serif',
                        color: '#000000',
                        textAlign: 'right',
                    ...
                    'Please enter an image URL')),
                ((_20 = this.props.filterSettings) === null || _20 === void 0 ? void 0 : _20.showDivider) && (React.createElement("div", { style: {
                        height: '1px',
                        backgroundColor: 'rgba(0, 0, 0, 0.1)',
                        marginTop: '12px',
                        marginBottom: '12px'
            ...
            React.createElement("div", { className: styles.itemsContainer }, Object.keys(this.groupItemsByCategory(this.getFilteredItems())).map(function (category) {
                ...
                return (React.createElement("div", { key: category, className: styles.itemPanel, style: __assign({}, _this.getCategorySectionBackgroundStyle()) },
                    React.createElement("button", { className: styles.itemHeader, onClick: function () { return _this.handleCategoryToggle(category); }, "aria-expanded": _this.state.expandedCategories.has(category) ? "true" : "false", style: {
                        ...
                        ((_b = (_a = _this.props.categorySectionSettings) === null || _a === void 0 ? void 0 : _a.icons) === null || _b === void 0 ? void 0 : _b.enabled) && (React.createElement("span", { className: styles.expandIcon, style: {
                    ...
                    _this.state.expandedCategories.has(category) && (React.createElement("div", { className: styles.itemContent }, items.map(function (item) {
                        var _a, _b, _c, _d;
