...
var FancyList = /** @class */ (function (_super) {
    ...
    FancyList.prototype.render = function () {
        var _this = this;
        var _a, _b, _c, _d;
        var _e = this.state, loading = _e.loading, error = _e.error, categories = _e.categories, selectedCategory = _e.selectedCategory, expandedItems = _e.expandedItems;
            ...
            ((_d = this.props.filterSettings) === null || _d === void 0 ? void 0 : _d.enabled) && (React.createElement(React.Fragment, null,
                React.createElement("div", { className: styles.categoryFilters, style: __assign(__assign({}, this.getFilterBackgroundStyle(this.props.filterSettings)), { position: 'relative', padding: '12px', marginBottom: '12px' }) },
                    this.props.filterSettings.background.type === 'image' &&
                        ...
                        this.props.filterSettings.background.imageAlpha > 0 && (React.createElement("div", { style: {
                            position: 'absolute',
                            top: 0,
                            left: 0,
                            right: 0,
                            bottom: 0,
                            background: "rgba(255,255,255,".concat(this.props.filterSettings.background.imageAlpha / 100, ")"),
                            pointerEvents: 'none',
                            zIndex: 1
                        } })),
                    React.createElement("div", { style: {
                        ...
                        categories.map(function (category) { return (React.createElement("button", { key: category, className: "".concat(styles.categoryPill, " ").concat(selectedCategory === category ? styles.active : ''), style: {
                                background: selectedCategory === category ? _this.props.filterSettings.activeColors.background : _this.props.filterSettings.inactiveColors.background,
                                color: selectedCategory === category ? _this.props.filterSettings.activeColors.font : _this.props.filterSettings.inactiveColors.font,
                                fontFamily: _this.props.filterSettings.font.family,
                                fontSize: _this.props.filterSettings.font.size,
                                fontWeight: _this.props.filterSettings.font.formatting.bold ? 'bold' : 'normal',
                                fontStyle: _this.props.filterSettings.font.formatting.italic ? 'italic' : 'normal',
                                textDecoration: _this.getTextDecoration(_this.props.filterSettings.font.formatting),
                                borderRadius: _this.getFilterBorderRadius(_this.props.filterSettings.shape),
                                border: 'none',
                                padding: '8px 16px',
                                margin: '4px',
                                cursor: 'pointer',
                ...
                (this.state.filterImageValidationError || this.state.filterImageLoadError ||
                    (this.props.filterSettings.background.type === 'image' && !this.props.filterSettings.background.image)) && (React.createElement("div", { style: {
                        fontSize: '12px',
                        fontFamily: 'Arial, sans-serif',
                        color: '#000000',
                        textAlign: 'right',
                    ...
                    'Please enter an image URL')),
                this.props.filterSettings.showDivider && (React.createElement("div", { style: {
                        height: '1px',
                        backgroundColor: 'rgba(0, 0, 0, 0.1)',
                        marginTop: '12px',
                        marginBottom: '12px'
