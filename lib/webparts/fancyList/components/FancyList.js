    ...
    FancyList.prototype.getCategorySectionBackgroundStyle = function () {
        ...
        switch (backgroundType) {
            ...
            case 'image':
                if (imageUrl) {
                    return {
                        background: "linear-gradient(rgba(255,255,255,".concat(imageAlpha / 100, "), rgba(255,255,255,").concat(imageAlpha / 100, ")), url(").concat(imageUrl, ")"),
                        backgroundSize: 'cover',
                        backgroundPosition: 'center',
                        borderRadius: this.getShapeRadius(shape)
                    };
        ...
        return (React.createElement("div", { className: styles.fancyList },
            ...
            React.createElement("div", { className: styles.itemsContainer }, Object.keys(this.groupItemsByCategory(this.getFilteredItems())).map(function (category) {
                ...
                return (React.createElement("div", { key: category, className: styles.itemPanel },
                    React.createElement("button", { className: styles.itemHeader, onClick: function () { return _this.handleCategoryToggle(category); }, "aria-expanded": _this.state.expandedCategories.has(category) ? "true" : "false", style: __assign({ display: 'flex', alignItems: 'center', justifyContent: 'space-between', width: '100%' }, _this.getCategorySectionBackgroundStyle()) },
