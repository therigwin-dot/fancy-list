        ...
        return (React.createElement("div", { className: styles.fancyList },
            ...
            React.createElement("div", { className: styles.itemsContainer }, Object.keys(this.groupItemsByCategory(this.getFilteredItems())).map(function (category) {
                ...
                return (React.createElement("div", { key: category, className: styles.itemPanel, style: __assign(__assign({}, _this.getCategorySectionBackgroundStyle()), { marginBottom: "".concat(divideSpace, "px") }) },
                    ...
                    isCategoryExpanded && (React.createElement("div", { className: styles.itemContent }, items.map(function (item) {
                        var _a, _b, _c, _d, _e, _f;
                        ...
                        return (React.createElement("div", { key: item.id, className: styles.itemPanel, style: __assign({ marginBottom: "".concat(divideSpace, "px"), border: 'none', borderRadius: '0', boxShadow: 'none' }, _this.getSubjectSectionBackgroundStyle() // Move background to wrapper div
                            ) },
                            React.createElement("button", { className: "".concat(styles.itemHeader, " ").concat(isItemExpanded ? styles.expanded : ''), onClick: function () { return _this.handleItemToggle(item.id); }, "aria-expanded": isItemExpanded ? "true" : "false", style: {
                                    display: 'flex',
                                    alignItems: 'center',
                                    justifyContent: 'space-between',
                                    width: '100%',
                            ...
                            isItemExpanded && (React.createElement("div", { className: styles.itemContent }, _this.renderDescriptionContent(item)))));
                    })))));
            }))));
    };
    return FancyList;
